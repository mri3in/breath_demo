			...
			switch ($code) {
				case SPREADSHEET_EXCEL_READER_TYPE_SST:
					...
					for ($i = 0; $i < $uniqueStrings; $i++) {
						...
						$retstr = ($asciiEncoding) ? iconv('cp1250', 'utf-8', $retstr) : $this->_encodeUTF16($retstr); //$retstr = ($asciiEncoding) ? $retstr : $this->_encodeUTF16($retstr); --> fix by suggestion from http://stackoverflow.com/questions/3666412/php-excel-reader-problem-with-utf-8
